                ...
                <ul class="block lg:flex">
                  <li class="relative" ref="megaMenuButtonRef">
                    ...
                    <div
                      ...
                      class="w-full rounded-xl bg-white p-2 lg:absolute lg:left-0 lg:top-full lg:w-[850px] lg:p-8 lg:shadow-lg dark:bg-dark"
                    >
                      <div class="grid gap-5 lg:grid-cols-2">
                        <div>
                          <h4 class="mb-3 text-sm font-semibold text-dark dark:text-white">
                            Get Started
                          </h4>
                          <div class="space-y-2">
                            <a
