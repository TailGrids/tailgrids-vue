      ...
      <div class="mx-auto w-full max-w-[500px]">
        <div class="relative">
          <textarea
            ...
            v-model="inputValue"
            ref="inputRef"
            class="w-full rounded-lg border border-stroke bg-gray-1 p-5 leading-relaxed text-body-color outline-hidden duration-200 selection:bg-transparent focus:border-primary dark:border-dark-3 dark:bg-dark-2 dark:text-dark-6"
          ></textarea>
          <button
