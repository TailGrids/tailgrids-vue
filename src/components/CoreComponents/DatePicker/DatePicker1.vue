  ...
  <section class="bg-white py-20 dark:bg-dark">
    <div class="container">
      <div class="mx-auto w-full max-w-[510px]">
        ...
        <div
          class="flex w-full flex-col rounded-xl bg-white p-4 shadow-four sm:p-[30px] dark:bg-dark-2 dark:shadow-box-dark"
        >
          <div class="flex items-center justify-between pb-4">
            ...
            <span class="text-xl font-medium capitalize text-dark dark:text-white">
              january - 2022
            </span>
            <div
              class="flex h-[38px] w-[38px] cursor-pointer items-center justify-center rounded-[7px] border-[.5px] border-stroke bg-gray-2 text-dark hover:border-primary hover:bg-primary hover:text-white sm:h-[46px] sm:w-[46px] dark:border-dark-3 dark:bg-dark dark:text-white"
          ...
          <div
            class="flex justify-between pb-2 pt-4 text-sm font-medium capitalize text-body-color sm:text-lg dark:text-dark-6"
          >
            <span
          ...
          <div class="flex justify-between pb-2 text-sm font-medium sm:text-lg">
            <span
              class="flex h-[38px] w-[38px] items-center justify-center rounded-[7px] border-[.5px] border-transparent text-body-color hover:border-stroke hover:bg-gray-2 sm:h-[46px] sm:w-[47px] dark:text-dark-6 dark:hover:border-dark-3 dark:hover:bg-dark"
            >
              30
            </span>
            ...
            <span
              class="flex h-[38px] w-[38px] items-center justify-center rounded-[7px] border-[.5px] border-transparent text-dark hover:border-stroke hover:bg-gray-2 sm:h-[46px] sm:w-[47px] dark:text-white dark:hover:border-dark-3 dark:hover:bg-dark"
            >
              01
            </span>
          ...
          <div class="flex justify-between pb-2 text-sm font-medium sm:text-lg">
            ...
            <span
              class="flex h-[38px] w-[38px] items-center justify-center rounded-md border-[.5px] border-primary bg-primary text-white sm:h-[46px] sm:w-[47px]"
            >
              09
            </span>
