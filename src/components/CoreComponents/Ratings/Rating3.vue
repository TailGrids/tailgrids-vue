      ...
      <div class="mx-auto w-full max-w-[470px]">
        ...
        >
          ...
          >
            ...
            <span class="text-base font-medium text-dark dark:text-white"> 4.7 out of 5 </span>
          </div>
          <p class="pb-10 pt-3 text-base font-medium text-body-color dark:text-dark-6">
            40 customer ratings
          </p>
          <div class="space-y-4">
            <div class="flex items-center justify-between">
              <span class="whitespace-nowrap text-base font-medium text-dark dark:text-white">
                5 star
              </span>
              <div class="relative mx-3 h-[14px] w-full rounded-full bg-gray-2 dark:bg-dark">
                <div class="absolute left-0 top-0 h-full w-[84%] rounded-full bg-[#FFA645]"></div>
              </div>
              <span class="whitespace-nowrap text-base font-medium text-dark dark:text-white">
                84%
              </span>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="relative mx-3 h-[14px] w-full rounded-full bg-gray-2 dark:bg-dark">
                <div class="absolute left-0 top-0 h-full w-[50%] rounded-full bg-[#FFA645]"></div>
              </div>
              <span class="whitespace-nowrap text-base font-medium text-dark dark:text-white">
                9%
              </span>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="relative mx-3 h-[14px] w-full rounded-full bg-gray-2 dark:bg-dark">
                <div class="absolute left-0 top-0 h-full w-[40%] rounded-full bg-[#FFA645]"></div>
              </div>
              <span class="whitespace-nowrap text-base font-medium text-dark dark:text-white">
                4%
              </span>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="relative mx-3 h-[14px] w-full rounded-full bg-gray-2 dark:bg-dark">
                <div class="absolute left-0 top-0 h-full w-[20%] rounded-full bg-[#FFA645]"></div>
              </div>
              <span class="whitespace-nowrap text-base font-medium text-dark dark:text-white">
                2%
              </span>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="relative mx-3 h-[14px] w-full rounded-full bg-gray-2 dark:bg-dark">
                <div class="absolute left-0 top-0 h-full w-[10%] rounded-full bg-[#FFA645]"></div>
              </div>
              <span class="whitespace-nowrap text-base font-medium text-dark dark:text-white">
                1%
              </span>
