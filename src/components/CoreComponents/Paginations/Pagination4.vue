...
<template>
  <div class="bg-white py-10 text-center dark:bg-dark">
    <div class="inline-flex gap-1 rounded-full border border-stroke p-3 dark:border-white/10">
      <ul class="flex items-center gap-1">
        <li>
          <a
            href="javascript:void(0)"
            @click="navigatePage(-1)"
            class="flex h-10 min-w-10 items-center justify-center rounded-full px-2 text-dark hover:bg-gray-2 dark:text-white dark:hover:bg-white/5"
          >
            <svg
              width="20"
              height="21"
