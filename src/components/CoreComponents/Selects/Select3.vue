    ...
    <div class="container">
      <div class="w-full max-w-[500px]">
        <div>
          ...
          <div
            class="relative flex flex-wrap items-center gap-2 px-4 py-3 bg-transparent border rounded-lg border-stroke dark:border-dark-3"
          >
            <span
              class="inline-flex items-center gap-2 py-1 pl-3 pr-2 border rounded-full border-stroke hover:bg-gray-2 dark:border-dark-3 dark:text-white dark:hover:bg-white/5"
            >
              Design
              <span class="cursor-pointer text-dark-5 hover:text-dark dark:hover:text-white">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
            ...
            <div class="relative flex-1">
              ...
              <span
                class="absolute top-0 right-0 flex items-center justify-center h-full pointer-events-none text-dark-5"
              >
                <svg
                  width="16"
                  height="16"
