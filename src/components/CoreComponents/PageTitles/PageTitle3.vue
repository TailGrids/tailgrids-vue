<template>
  ...
  <section class="dark:bg-dark bg-white py-[70px]">
    <div class="mx-auto px-4 sm:container">
      <div class="border-stroke dark:border-dark-3 items-center justify-between border-b md:flex">
        <div class="mb-6 w-full">
          <h2 class="text-dark mb-2 text-2xl font-semibold dark:text-white">Your Favorite Items</h2>
