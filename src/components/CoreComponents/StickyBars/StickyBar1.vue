<template>
  <section class="px-6 py-3 border-b border-stroke bg-gray-1 dark:border-dark-3 dark:bg-dark-2">
    <div class="container">
      <div class="relative pr-6 text-center">
        <span
          class="inline-flex h-6 items-center justify-center rounded-sm bg-primary/10 px-2.5 text-sm font-medium text-primary"
        >
          New
        </span>
        ...
        <a
          ...
          class="inline-flex items-center gap-2 text-sm font-medium text-primary lg:text-base"
        >
          Check Out
          <span>
            <svg
        ...
        <button
          class="absolute right-0 flex items-center justify-center w-6 h-6 duration-200 -translate-y-1/2 top-1/2 text-dark-6 hover:text-dark dark:hover:text-white"
        >
          <svg
            width="14"
            height="14"
