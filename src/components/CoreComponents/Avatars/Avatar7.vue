  ...
  <section class="bg-white py-[75px] dark:bg-dark">
    <div class="mx-auto px-4 sm:container">
      <div class="flex items-end justify-center space-x-2 sm:space-x-5">
        ...
        <div class="relative h-[38px] w-[38px] rounded">
          <img
            src="https://cdn.tailgrids.com/2.0/image/dashboard/images/avatar/image-05.jpg"
            alt="avatar"
            class="h-full w-full rounded object-cover object-center"
        ...
        <div class="relative h-[42px] w-[42px] rounded">
          <img
            src="https://cdn.tailgrids.com/2.0/image/dashboard/images/avatar/image-05.jpg"
            alt="avatar"
            class="h-full w-full rounded object-cover object-center"
        ...
        <div class="relative h-[52px] w-[52px] rounded">
          <img
            src="https://cdn.tailgrids.com/2.0/image/dashboard/images/avatar/image-05.jpg"
            alt="avatar"
            class="h-full w-full rounded object-cover object-center"
        ...
        <div class="relative h-20 w-20 rounded">
          <img
            src="https://cdn.tailgrids.com/2.0/image/dashboard/images/avatar/image-05.jpg"
            alt="avatar"
            class="h-full w-full rounded object-cover object-center"
