<template>
  <section class="bg-white py-20 dark:bg-dark">
    <div class="container">
      <div class="mx-auto w-full max-w-[510px]" ref="datepickerContainerRef">
        <div class="relative mb-3">
          ...
          />
          <span  id="toggleDatepicker" class="absolute inset-y-0 flex h-12 w-12 items-center justify-center text-dark-5" @click="handleToggleCalendar">
            <svg
              width="21"
              height="20"
              viewBox="0 0 21 20"
        ...
        >
          <div class="flex items-center justify-between pb-4">
            ...
            <span id="currentMonth" class="text-xl font-medium capitalize text-dark dark:text-white">
          ...
          >
           ...
           <div
              ref="daysContainer"
              id="days-container"
              class="grid grid-cols-7 text-sm font-medium sm:text-lg"
            >
              ...
              <div
                ...
                :class="{ 'bg-primary text-white': isSelected(day) }"
