<template>
  <section class="bg-gray-2 py-[60px] dark:bg-dark">
    <div class="mx-auto px-4 sm:container">
      <div
        class="relative flex max-w-[415px] items-center rounded-lg border border-stroke bg-white px-5 py-4 shadow-1 dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark"
      >
        <button class="absolute right-3 top-3 text-dark-5 hover:text-red dark:text-dark-6">
          <svg
            width="14"
            height="14"
            viewBox="0 0 14 14"
        ...
        <div class="w-full">
          <h6 class="text-base font-medium text-dark dark:text-white">Nelly Miller</h6>
          <div class="flex flex-wrap items-end justify-between gap-2">
            <p class="text-sm text-body-color dark:text-dark-6">Purchased polo t-shirt for man</p>
            <span class="text-xs text-body-color dark:text-dark-6"> 2 min ago </span>
          </div>
        </div>
      </div>
    </div>
