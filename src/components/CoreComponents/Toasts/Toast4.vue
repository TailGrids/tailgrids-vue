    ...
    <div class="mx-auto px-4 sm:container">
      ...
      >
        ...
        <div class="w-full pr-4 sm:pr-10">
          <h6 class="mb-2 text-base font-semibold text-dark sm:text-lg dark:text-white">
            New update! available
          </h6>
          <p class="mb-5 text-sm text-body-color dark:text-dark-6">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec ligula at dolor
            aliquam mollis.
          </p>
          <button class="text-base font-medium text-primary hover:underline">Update now</button>
        </div>
        <button class="hover:text-danger absolute right-4 top-4 text-dark-5 dark:text-dark-6">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
