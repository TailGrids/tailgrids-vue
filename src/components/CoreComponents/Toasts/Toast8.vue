  ...
  <section class="bg-gray-2 py-[60px] dark:bg-dark">
    <div class="mx-auto px-4 sm:container">
      <div class="flex justify-end">
        <div
          class="relative flex w-full max-w-[460px] items-center overflow-hidden rounded-lg bg-white px-5 py-[18px] shadow-1 dark:bg-dark-2 dark:shadow-box-dark"
        >
          <span class="absolute bottom-0 left-0 block h-[3px] w-full bg-stroke dark:bg-dark-3">
            <span class="absolute left-0 top-0 h-full w-3/4 bg-primary"></span>
          </span>
          <span
            class="mr-4 flex h-[30px] w-full max-w-[30px] items-center justify-center rounded-full border border-primary"
          >
            <svg
              width="16"
              height="16"
          ...
          <p class="text-base font-medium text-primary sm:text-lg">Your email is sending...</p>
          <button
