<template>
  <div
    class="border-l-yellow dark:bg-dark-2 flex max-w-[655px] items-center rounded-md border-l-[6px] bg-white p-5 pl-6"
  >
    <div
      class="bg-yellow mr-5 flex h-[36px] w-full max-w-[36px] items-center justify-center rounded-full"
    >
      <svg
        width="18"
        height="18"
