<template>
  <div
    class="border-stroke dark:border-dark-3 mb-11 flex items-center rounded-md border border-l-[8px] border-l-[#00B078] bg-white dark:bg-dark-2 p-5 pl-8"
  >
    <div
    ...
    <div class="flex w-full items-center justify-between">
      <div>
        <h3 class="mb-1 text-lg font-medium text-dark dark:text-white">
