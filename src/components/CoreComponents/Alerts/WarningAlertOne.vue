<template>
  <div
    class="shadow-1 dark:bg-dark-2 flex w-full rounded-lg border-l-[6px] border-transparent bg-white px-7 py-8 md:p-9"
  >
    <div
      class="bg-red-light-5 dark:bg-red-dark text-red-dark mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-lg dark:text-white"
    >
      <svg
        width="18"
        height="18"
