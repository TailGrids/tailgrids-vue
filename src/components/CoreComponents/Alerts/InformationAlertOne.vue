<template>
  <div
    class="border-l-cyan-dark dark:bg-dark-2 flex max-w-[655px] items-center rounded-md border-l-[6px] bg-white p-5 pl-6"
  >
    <div
    ...
    <div class="flex w-full items-center justify-between">
      <div>
        <h3 class="text-dark mb-1 text-lg font-medium dark:text-white">Did you know?</h3>
      ...
      <div>
        <button
          class="text-dark-3 hover:text-dark dark:text-dark-4 dark:hover:text-dark-6 duration-300"
        >
          <svg
            width="20"
            height="20"
